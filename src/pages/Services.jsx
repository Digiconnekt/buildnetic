    ...
    <>
          ...
          <div className="row clearfix">
            ...
            <div className="service-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box">
                ...
                ></div>
                <div className="icon-box">
                  <span className="icon flaticon-line-chart"></span>
                  <div
                    className="icon-five"
                    style={{ backgroundImage: "url(images/icons/icon-6.png)" }}
                  ></div>
            ...
            <div className="service-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box">
                ...
                ></div>
                <div className="icon-box">
                  <span className="icon flaticon-gear"></span>
                  <div
                    className="icon-five"
                    style={{ backgroundImage: "url(images/icons/icon-6.png)" }}
                  ></div>
            ...
            <div className="service-block-four col-lg-4 col-md-6 col-sm-12">
              <div className="inner-box">
                ...
                ></div>
                <div className="icon-box">
                  <span className="icon flaticon-cloud-computing"></span>
                  <div
                    className="icon-five"
                    style={{ backgroundImage: "url(images/icons/icon-6.png)" }}
                  ></div>
      ...
      <section className="business-section">
        <div
          ...
          style={{ backgroundImage: "url(images/background/pattern-23.png)" }}
        ></div>
        <div className="auto-container">
          <div className="sec-title light" style={{ textAlign: "center" }}>
            <div className="title">Expertise</div>
            <h2>Technical Expertise</h2>
            <div className="text">
              From keyword research to technical auditing to site migration, our
              team of technical <br /> SEOs are true experts in their field.
            </div>
          </div>
              ...
              <div className="image-column col-lg-6 col-md-12 col-sm-12">
                <div className="inner-column">
                  ...
                  <div
                    ...
                    data-wow-duration="1500ms"
                  >
                    <img src="images/resource/business-arrow.png" alt="" />
                  </div>
                </div>
              </div>
                  ...
                  <div className="business-block">
                    <div className="inner-box">
                      ...
                      <div className="content">
                        ...
                        <div className="text">
                          AWS, Jenkins, <br /> Docker, Kubernet
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="inner-box">
                ...
                <div className="author-image-outer">
                  ...
                  <div className="rating">
                    ...
                    <span className="fa fa-star"></span>
                    <span className="fa fa-star"></span>
                    <span className="fa fa-star dark"></span>
                  </div>
                  <div className="text">
                    i liked working with these creative guys, who know
                    everything about quality design, innovations and usability,
                  </div>
                  <div className="lower-box">
                    <div className="quote-icon fa fa-quote-left"></div>
                    ...
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">
                          ...
                          ambitious businesses like yours generate more profits
                          by building awareness, driving web traffic, connecting
                          with customers.
                        </div>
                      </div>
                    </div>
